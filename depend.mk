...
$(LIBCOMMON_ROOT)src/appdata.o: $(LIBCOMMON_ROOT)src/appdata.c $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/logger.h $(LIBCOMMON_ROOT)include/common/misc.h $(LIBCOMMON_ROOT)include/common/path.h $(LIBCOMMON_ROOT)include/common/size.h
...
$(LIBCOMMON_ROOT)src/error-windows.o: $(LIBCOMMON_ROOT)src/error-windows.c $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/size.h
	$(CC) $(CFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
$(LIBCOMMON_ROOT)src/error-winnt.o: $(LIBCOMMON_ROOT)src/error-winnt.c $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/lazy.h
	$(CC) $(CFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
...
$(LIBCOMMON_ROOT)src/size.o: $(LIBCOMMON_ROOT)src/size.c $(LIBCOMMON_ROOT)include/common/size.h
	$(CC) $(CFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
$(LIBCOMMON_ROOT)src/thread.o: $(LIBCOMMON_ROOT)src/thread.c $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/mutex.h $(LIBCOMMON_ROOT)include/common/mutex.h $(LIBCOMMON_ROOT)include/common/thread.h
	$(CC) $(CFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
...
$(LIBCOMMON_ROOT)src/winutf.o: $(LIBCOMMON_ROOT)src/winutf.c $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/misc.h
	$(CC) $(CFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
$(LIBCOMMON_ROOT)src/pstream.o: $(LIBCOMMON_ROOT)src/pstream.cc $(LIBCOMMON_ROOT)include/common/c++/../error.h $(LIBCOMMON_ROOT)include/common/c++/../refcnt.h $(LIBCOMMON_ROOT)include/common/c++/new.h $(LIBCOMMON_ROOT)include/common/c++/refcount.h $(LIBCOMMON_ROOT)include/common/c++/stream.h $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/misc.h
	$(CXX) $(CXXFLAGS) $(CFLAGS) $(LIBCOMMON_CXXFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
$(LIBCOMMON_ROOT)src/scheduler.o: $(LIBCOMMON_ROOT)src/scheduler.cc $(LIBCOMMON_ROOT)include/common/c++/../error.h $(LIBCOMMON_ROOT)include/common/c++/scheduler.h $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/mutex.h $(LIBCOMMON_ROOT)include/common/sem.h
	$(CXX) $(CXXFLAGS) $(CFLAGS) $(LIBCOMMON_CXXFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
$(LIBCOMMON_ROOT)src/stream.o: $(LIBCOMMON_ROOT)src/stream.cc $(LIBCOMMON_ROOT)include/common/c++/../error.h $(LIBCOMMON_ROOT)include/common/c++/../refcnt.h $(LIBCOMMON_ROOT)include/common/c++/refcount.h $(LIBCOMMON_ROOT)include/common/c++/stream.h $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/misc.h
	$(CXX) $(CXXFLAGS) $(CFLAGS) $(LIBCOMMON_CXXFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
$(LIBCOMMON_ROOT)src/thread-cpp.o: $(LIBCOMMON_ROOT)src/thread-cpp.cc $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/mutex.h $(LIBCOMMON_ROOT)include/common/thread.h
	$(CXX) $(CXXFLAGS) $(CFLAGS) $(LIBCOMMON_CXXFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
$(LIBCOMMON_ROOT)src/worker.o: $(LIBCOMMON_ROOT)src/worker.cc $(LIBCOMMON_ROOT)include/common/c++/../cas.h $(LIBCOMMON_ROOT)include/common/c++/../error.h $(LIBCOMMON_ROOT)include/common/c++/../error.h $(LIBCOMMON_ROOT)include/common/c++/../misc.h $(LIBCOMMON_ROOT)include/common/c++/../mutex.h $(LIBCOMMON_ROOT)include/common/c++/../sem.h $(LIBCOMMON_ROOT)include/common/c++/../thread.h $(LIBCOMMON_ROOT)include/common/c++/lock.h $(LIBCOMMON_ROOT)include/common/c++/ring.h $(LIBCOMMON_ROOT)include/common/c++/scheduler.h $(LIBCOMMON_ROOT)include/common/c++/worker.h $(LIBCOMMON_ROOT)include/common/thread.h
	$(CXX) $(CXXFLAGS) $(CFLAGS) $(LIBCOMMON_CXXFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
...
$(LIBCOMMON_ROOT)src/error-apple.o: $(LIBCOMMON_ROOT)src/error-apple.m $(LIBCOMMON_ROOT)include/common/error.h
	$(CC) $(OBJCFLAGS) $(CFLAGS) $(LIBCOMMON_OBJCFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
$(LIBCOMMON_ROOT)src/crypto/hash.o: $(LIBCOMMON_ROOT)src/crypto/hash.c $(LIBCOMMON_ROOT)include/common/crypto/../error.h $(LIBCOMMON_ROOT)include/common/crypto/../misc.h $(LIBCOMMON_ROOT)include/common/crypto/hash.h $(LIBCOMMON_ROOT)include/common/crypto/misc.h
	$(CC) $(CFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
$(LIBCOMMON_ROOT)src/crypto/md5.o: $(LIBCOMMON_ROOT)src/crypto/md5.c $(LIBCOMMON_ROOT)include/common/crypto/../error.h $(LIBCOMMON_ROOT)include/common/crypto/../misc.h $(LIBCOMMON_ROOT)include/common/crypto/hash.h $(LIBCOMMON_ROOT)include/common/crypto/md5.h $(LIBCOMMON_ROOT)include/common/crypto/misc.h
	$(CC) $(CFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
$(LIBCOMMON_ROOT)src/crypto/rng.o: $(LIBCOMMON_ROOT)src/crypto/rng.c $(LIBCOMMON_ROOT)include/common/crypto/../error.h $(LIBCOMMON_ROOT)include/common/crypto/rng.h $(LIBCOMMON_ROOT)include/common/error.h $(LIBCOMMON_ROOT)include/common/lazy.h $(LIBCOMMON_ROOT)include/common/misc.h
	$(CC) $(CFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
$(LIBCOMMON_ROOT)src/crypto/sha1.o: $(LIBCOMMON_ROOT)src/crypto/sha1.c $(LIBCOMMON_ROOT)include/common/crypto/../error.h $(LIBCOMMON_ROOT)include/common/crypto/../misc.h $(LIBCOMMON_ROOT)include/common/crypto/hash.h $(LIBCOMMON_ROOT)include/common/crypto/misc.h $(LIBCOMMON_ROOT)include/common/crypto/sha1.h
	$(CC) $(CFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
$(LIBCOMMON_ROOT)src/crypto/sha256.o: $(LIBCOMMON_ROOT)src/crypto/sha256.c $(LIBCOMMON_ROOT)include/common/crypto/../error.h $(LIBCOMMON_ROOT)include/common/crypto/../misc.h $(LIBCOMMON_ROOT)include/common/crypto/hash.h $(LIBCOMMON_ROOT)include/common/crypto/misc.h $(LIBCOMMON_ROOT)include/common/crypto/sha256.h
	$(CC) $(CFLAGS) $(LIBCOMMON_CFLAGS) -c -o $@ $<
